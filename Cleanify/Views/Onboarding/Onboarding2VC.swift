...
class Onboarding2VC: UIViewController {
    ...
    private func setupUI() {
        ...
        // Title
        titleLabel.text = "Find & Remove Duplicates"
        ...
        // Subtitle
        subtitleLabel.text = "Free up valuable space by cleaning similar photos and large videos."
        ...
        highlightDescLabel.text = "Our advanced scanning helps you find duplicates and similar items instantly."
